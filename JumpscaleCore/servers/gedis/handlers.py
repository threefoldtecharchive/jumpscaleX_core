...
class Handler(JSBASE):
    ...
    def _handle_request(self, request, address, user_session):
        ...
        if request.command.command == "command":
            ...
            current_threebot_id = int(j.myidentities.me.default.tid)
            ...
            if current_threebot_id != tid:
                ...
                try:
                    VerifyKey(binascii.unhexlify(j.myidentities.me.default.nacl.verify_key_hex)).verify(
                ...
                user_session.threebot_name = j.myidentities.me.default.name
            return None, "OK"
