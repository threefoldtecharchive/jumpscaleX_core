...
class Handler(JSBASE):
    ...
    def _handle_request(self, request, address, user_session):
        ...
        if request.command.command == "command":
            ...
            current_threebot_id = int(j.me_identities.me.default.tid)
            ...
            if current_threebot_id != tid:
                ...
                try:
                    VerifyKey(binascii.unhexlify(j.me_identities.me.default.nacl.verify_key_hex)).verify(
                ...
                user_session.threebot_name = j.me_identities.me.default.name
            return None, "OK"
